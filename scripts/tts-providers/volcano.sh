...
#
# Optional env:
#   VOLCANO_TTS_VOICE   voice ID (default: zh_female_yingyujiaoxue_uranus_bigtts)
...
Volcano Ark Agent Plan TTS (seed-tts-2.0)
  ...
  Voice:       export VOLCANO_TTS_VOICE=zh_female_yingyujiaoxue_uranus_bigtts

Dependencies: curl, jq, python3 (for base64 -d fallback)
EOF
}
